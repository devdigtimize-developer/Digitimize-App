...
const serviceDetails: Record<string, ServiceContent> = {
  'gohighlevel-automation': { icon: Workflow, eyebrow: 'CRM & automation systems', title: 'Build a lead system that keeps moving after the first conversation.', description: 'GoHighLevel setup, automation, and integration for teams that want fewer missed follow-ups and a clearer path from lead to customer.', outcome: 'From scattered leads to one operating system for growth.', tools: ['GHL Workflows', 'Pipeline Stages', 'Conversation AI', 'Capture Funnels', 'Booking & Reminders', 'Webhook Bridges'], included: ['CRM setup and cleanup', 'Custom sales pipelines', 'Automated SMS and email follow-up', 'Funnels and landing pages', 'Calendar automation', 'Third-party integrations'] },
  'web-development': { icon: Globe2, eyebrow: 'Web development', title: 'A website that gives your business room to grow.', description: 'Strategy, design, and development for fast, clear websites that make your value easier to understand and your next action easier to take.', outcome: 'From a digital brochure to a useful growth platform.', tools: ['WordPress', 'React', 'Site Architecture', 'Design Systems', 'Editable CMS', 'SEO Foundations'], included: ['Custom responsive design', 'WordPress and React development', 'Performance optimization', 'SEO-ready structure', 'CMS and content setup', 'Launch and ongoing support'] },
  'mobile-app-development': { icon: Smartphone, eyebrow: 'Mobile app development', title: 'Mobile products that make the next action effortless.', description: 'Focused mobile experiences designed around real user behavior, connected to the systems your business already depends on.', outcome: 'From a product idea to a useful daily habit.', tools: ['React Native', 'iOS & Android', 'User Flows', 'Prototyping', 'Push Notifications', 'App Store Launch'], included: ['Product discovery and UX', 'iOS and Android interfaces', 'Cross-platform app development', 'API and backend integration', 'Analytics and notifications', 'Store launch support'] },
  'ecommerce-development': { icon: Store, eyebrow: 'Ecommerce development', title: 'Commerce experiences designed to turn browsing into buying.', description: 'We build the storefront, product journey, and operational connections that help customers buy with confidence.', outcome: 'From product catalog to a smoother path to checkout.', tools: ['Catalog Structure', 'Search & Filters', 'Checkout Flow', 'Payments & Shipping', 'Inventory Sync', 'Sales Analytics'], included: ['Store strategy and architecture', 'Product and collection design', 'Checkout experience', 'Payment and shipping setup', 'Marketing integrations', 'Analytics and optimization'] },
  'shopify-development': { icon: Store, eyebrow: 'Shopify development', title: 'A Shopify store ready for your next stage of growth.', description: 'A flexible Shopify experience shaped around your products, customers, and operations, with room to keep improving.', outcome: 'From a theme to a store your team can own.', tools: ['Shopify Themes', 'Liquid Sections', 'Product Templates', 'Klaviyo Flows', 'Subscription Apps', 'Speed Optimization'], included: ['Shopify theme customization', 'Custom sections and templates', 'Product page optimization', 'App and fulfillment integrations', 'Speed and conversion improvements', 'Shopify handoff and support'] },
  'custom-software': { icon: Code2, eyebrow: 'Custom software', title: 'Tools and workflows built for the work nobody else sees.', description: 'Practical internal software, dashboards, and integrations that make complex operations easier to understand and run.', outcome: 'From manual work to a system your team can trust.', tools: ['Workflow Mapping', 'Internal Dashboards', 'System Connections', 'Database Design', 'Role-Based Access', 'Cloud Deployment'], included: ['Workflow and technical audit', 'Internal dashboards', 'API and database integrations', 'Role-based access', 'Automation and reporting', 'Cloud deployment'] },
};
